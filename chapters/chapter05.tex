...
When vibration data were used for detecting bearings fault in \ref{sec:etude_de_cas_diagnostique_des_roulements}, vibration signals were transformed into images by reshaping 1D signals into 2D arrays which were used as an input to a \acrshort{cnn}. This approach worked very well for diagnositcs but it can't be used for prognostics. 
...
\subsection{Prediction of bearings RUL using neural networks}%
\label{sub:prediction_of_bearings_rul_using_neural_networks}
